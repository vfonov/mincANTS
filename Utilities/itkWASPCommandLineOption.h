/*=========================================================================
  ...
  Module:    $RCSfile: itkWASPCommandLineOption.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkWASPCommandLineOption_h
#define __itkWASPCommandLineOption_h
...
class ITK_EXPORT WASPCommandLineOption
: public DataObject
{
public:
    typedef WASPCommandLineOption                        Self;
...
protected:
    WASPCommandLineOption();
    virtual ~WASPCommandLineOption() {};
