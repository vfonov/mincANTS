...
public:
 ...
 // typedef Eigen::JacobiSVD<eMatrix> svdobj;
  ...
  RealType LineSearch( MatrixType& A , VectorType&  x_k , VectorType&  p_k , VectorType&  b , 
		       RealType minalph  , RealType maxalph  , bool );
  RealType EvaluateEnergy( MatrixType& A , VectorType&  x_k , VectorType&  p_k , VectorType&  b , 
		       RealType minalph  ,  bool );
  RealType SparseConjGrad( VectorType& , VectorType , RealType , unsigned int );
  RealType ConjGrad( typename antsSCCANObject<TInputImage, RealType>::MatrixType& A , typename antsSCCANObject<TInputImage, RealType>::VectorType& x_k ,
                     typename antsSCCANObject<TInputImage, RealType>::VectorType  b_in , RealType convcrit = 1.e-3 , unsigned int maxits = 5 );
  RealType SparseNLConjGrad( typename antsSCCANObject<TInputImage, TRealType>::MatrixType& A,  typename antsSCCANObject<TInputImage, TRealType>::VectorType& x_k ,
...
// for pscca
  ...
  RealType GoldenSection( MatrixType& A , VectorType&  x_k , VectorType&  p_k , VectorType&  bsol ,
    RealType minalph  , RealType maxalph  , bool keeppos, RealType a, RealType b, RealType c, RealType tau );
