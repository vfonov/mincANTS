...
but with the N4 corrected image as input.  Thus, we are able to
compare the impact of bias on our N4 and Atropos algorithm and also
the validity of our prior label image initialization.  The prior label
image manual initialization was based on a crude ITK-SNAP-based labeling of a
small set of voxels for each tissue.  
\begin{figure}
\begin{center}
\begin{tabular}{c}
...
\end{center}
\end{figure}
\subsubsection{20 Subject Evaluation}
...
ground truth labels cover 68 classes and much of the brain.  Some
...
{\textcolor{red}{ Elaborate after including the results.} }
