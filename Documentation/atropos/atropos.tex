...
and variance,
\begin{align}  
 \sigma^2_k \leftarrow  \frac{ \sum_{i=1}^N  (y_i - \mu_k ) p_k(l_k|y_i)}{ \sum_{i=1}^N p_k(l_k|y_i) }.
\end{align}
...
\begin{align}
 \boldsymbol{\Sigma}_{mn,k} \leftarrow \frac{ \sum_{i=1}^N  ( \mathbf{y}_i - \boldsymbol{\mu}_k ) p_k(l_k|\mathbf{y}_i)}{1 - \sum_{i=1}^N p^2_k(l_k|\mathbf{y}_i) }.
\end{align}
