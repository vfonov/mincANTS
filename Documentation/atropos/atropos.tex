...
noise braineweb single subject data finding 0.932 (GM) and .961 (WM)
...
for comparison.  Topology preserving approaches also perform well.
...
\cite{Bazin2007c} proposed the TOADS method and, estimating from the
