...
\newline
\newline
{\color{blue}{We apologize.  In preparing the original
...
\newline
\newline
{\color{blue}{We added the following elaboration on the benefits of N4 in section 3.4.3 (page 21):
\begin{quote}
