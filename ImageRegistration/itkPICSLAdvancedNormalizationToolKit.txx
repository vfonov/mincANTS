...
//    this->m_Parser->SetCommandDescription( " PICSL Advanced Image Normalization Toolkit" );
    ...
    if (true)
    {
        ...
        option->SetDescription( "restrict deformation to zero along specified dimensions -- a 'vector' of length ImageDimension e.g. in 3D : 0x1x0 --- will restrict along y only " );
