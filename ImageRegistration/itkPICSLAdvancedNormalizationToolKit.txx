...
//    }
    ...
    if (true)
    {
        ...
        option->SetShortName( 'T' );
        option->SetDescription( " = true / false ,  compute the Euclidean length of the diffeomorphism and write to an image -- OutputNamethick.nii.gz -- This is a Beta version of thickness computation -- Not Full-Blown DiReCT , Das, 2009, Neuroimage ---  syn with time is the only model that can be used with this option " );
        this->m_Parser->AddOption( option );
    }
    ...
    if (true) {
         ...
         option->SetDescription( "MI: mutual information (default), MSE: mean square error" );
