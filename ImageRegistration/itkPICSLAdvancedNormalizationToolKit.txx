...
//    this->m_Parser->SetCommandDescription( " PICSL Advanced Image Normalization Toolkit" );
    ...
    if (true)
    {
        ...
        option->SetDescription( "restrict deformation by scalar factors along specified dimensions -- a float 'vector' of length ImageDimension to multiply against the gradient values ---  e.g. in 3D : 0.1x1x0 --- will set the z deformation to zero and scale x by 0.1 and y by 1 (no change). " );
