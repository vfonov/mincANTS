...
template<class TScalarType>
ANTSAffine3DTransform<TScalarType>::
ANTSAffine3DTransform( unsigned int outputSpaceDimension, 
...
template <class TScalarType>
const 
typename ANTSAffine3DTransform<TScalarType>::ParametersType & 
ANTSAffine3DTransform<TScalarType>
::GetParameters() const
{
...
template<class TScalarType>
typename ANTSAffine3DTransform<TScalarType>::MatrixType ANTSAffine3DTransform<TScalarType>::
