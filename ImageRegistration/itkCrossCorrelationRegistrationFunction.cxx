...
//  std::cout << "makeimg " << makeimg << " fix " << this->GetFixedImage()->GetLargestPossibleRegion().GetSize() << std::endl;
  if (makeimg)
    {  
...
//      unsigned int inct=0;
      ...
      if (this->m_FixedImageMask) if (this->m_FixedImageMask->GetPixel( oindex  ) < 1.e-6 ) takesample=false;
