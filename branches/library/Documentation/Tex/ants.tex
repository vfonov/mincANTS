...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item weight for this metric is 1 (the weights are relative to
          the weights on the $N$ other metrics passed to ANTS --- $N$
          is unlimited).  So, the weight, $w_i$ on the $i^{th}$ metric
          will be  $w_i=w_i/ ( \sum_i  w_i )$.
