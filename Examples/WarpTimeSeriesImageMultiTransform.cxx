...
int main(int argc, char **argv){
    ...
    if (argc<=3){
      std::cout << argv[0] << " ImageDimension moving_image output_image -R fixed_image  MyWarp.nii.gz MyAffine.txt --use-NN (Nearest Neighbor Interpolator) " << std::endl;
      std::cout << argv[0] << " ImageDimension fixed_image output_image -R moving_image  -i MyAffine.txt  MyInverseWarp.nii.gz --use-NN (Nearest Neighbor Interpolator) " << std::endl;
