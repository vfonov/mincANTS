...
//        }
//      }
    else if( std::strcmp( whichTransform.c_str(), "displacementfield" ) == 0 ||  std::strcmp( whichTransform.c_str(), "df" ) == 0 )
      {
      ...
      if( std::strcmp( whichRegularization.c_str(), "gauss" ) == 0 || std::strcmp( whichRegularization.c_str(), "gaussian" ) == 0 )
        {
      ...
      else if( std::strcmp( whichRegularization.c_str(), "bspline" ) == 0 || std::strcmp( whichRegularization.c_str(), "dmffd" ) == 0 )
        {
        ...
        std::vector<unsigned int> meshSizeForTheUpdateField = parser->ConvertVector<unsigned int>( regularizationOption->GetParameter( currentStage, 0 ) );
        std::vector<unsigned int> meshSizeForTheTotalField = parser->ConvertVector<unsigned int>( regularizationOption->GetParameter( currentStage, 1 ) );
...
void InitializeCommandLineOptions( itk::ants::CommandLineParser *parser )
{
  ...
  option->SetUsageOption( 4, "TimeVaryingVelocityField[gradientStep,numberOfTimeIndices,updateFieldSigmaInPhysicalSpace,totalFieldSigmaInPhysicalSpace,updateFieldTimeSigma,totalFieldTimeSigma]" );
  option->SetDescription( description );
  parser->AddOption( option );
  }
